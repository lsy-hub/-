<template>
    <div id="app">
        ...
        <!-- 完成动态轮播图 -->
         <div class="mine-div" style="padding-bottom:50px; background-color: #121212;">
          ...
          <van-swipe :loop="true" :autoplay="3000" indicator-color="#fff"  >
              ...
              >
                  ...
                  <span class="text-span" style="margin-bottom: 20px !important">入手这款挑战性极强的角色扮演游戏，体验紧张激烈的回合制战斗，欣赏令人难忘的艺术设定。现已推出！</span>
                  <span>￥255</span>
                  </div>
              </van-swipe-item>
      ...
      <div style="padding-bottom:50px; background-color: #121212;">
          ...
          <van-swipe-item v-for="(image, index) in image" :key="index" style="width:226px;margin-left: 15px;">
          <img v-lazy="image"
            width="226"
            height="302"
          ...
          <div style="display:flex;flex-direction: column;">
            ...
            <span class="text-over over2">We Create Stuff | Modus Gamesaaaaaa</span>
            <div style="margin-top:15px;">
              <van-button class="cost-buttom" size="mini" color='#0074e4' style="border-radius:4px;"
              >-20%</van-button>
                  <span class="pirce" style="text-decoration:line-through;">￥103</span>
                  <span class="pirce" style="color: rgb(245, 245, 245);">￥82.40</span>
      ...
      <div style="background:#2a2a2a;padding-bottom:30px;">
        <div class="free-title">
            ...
            <div>
                ...
                color="#2a2a2a" 
                size="small"  
                style="border: 1px solid #fff; width:92px;">查看更多</van-button>
            </div>
        </div>
        <van-swipe :loop="false"  :width="328" >
          <van-swipe-item v-for="(image, index) in imagess" :key="index" style="width:305px;margin-left:16px;">
            <img 
            v-lazy="image"
            width="305"
            height="172"
          ...
          <van-swipe-item  >
            <div class="goods-out">
              <div style="padding:0px 16px;">
                ...
                <ul v-for="item in sales" :key="item.id" style="padding-left:16px;">
                  <li>
                    <div class="goods-box">
